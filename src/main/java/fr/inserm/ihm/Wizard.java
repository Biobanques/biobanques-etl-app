...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
	...
	/**
	 * 
	 backButtonIcon=backIcon.gif nextButtonIcon=nextIcon.gif cancelButtonIcon=cancelIcon.gif
	 * finishButtonIcon=finishIcon.gif
	 */
	static String BACK_TEXT = "Précédent";
	static String NEXT_TEXT = "Suivant";
	static String FINISH_TEXT = "Annuler";
	static String CANCEL_TEXT = "Quitter";

	// The image icons used for the buttons. Filenames are loaded from a
	// property resource file.

	static ImageIcon BACK_ICON;
	 ...
	 * 
	 * @param evt
	 *            PropertyChangeEvent passed from the model to signal that one of its properties has changed value.
	 */
	@Override
	...
	private void initComponents() {
		...
		backButton = new JButton(ImageStaticResource.getImageBackIcon());
		nextButton = new JButton(ImageStaticResource.getImageNextIcon());
		cancelButton = new JButton(ImageStaticResource.getImageCancelIcon());
		...
		buttonPanel.setBackground(theme.getVioletpastel());
		...
		buttonBox.setBackground(theme.getVioletpastel());
		buttonPanel.add(buttonBox, java.awt.BorderLayout.EAST);
		cardPanel.setBackground(theme.getVioletpastel());

		JPanel southPanel = new JPanel();
		southPanel.setBackground(theme.getVioletpastel());
		GridLayout southLayout = new GridLayout(0, 2);
		southPanel.setLayout(southLayout);
		JLabel version = new JLabel("biobanques-connecteur " + Main.propertiesBean.getVersionNumber());
		JLabel copyright = new JLabel("Copyright Inserm");
		version.setHorizontalAlignment(JLabel.RIGHT);
		southPanel.add(copyright);
		southPanel.add(version);

		JPanel southPanelWithButtons = new JPanel(new GridBagLayout());
		GridBagConstraints btnConstraint = new GridBagConstraints();
		btnConstraint.gridx = 0;
		btnConstraint.gridy = 0;
		btnConstraint.weightx = 1;
		btnConstraint.weighty = 70;
		btnConstraint.fill = GridBagConstraints.HORIZONTAL;
		southPanelWithButtons.add(buttonPanel, btnConstraint);

		GridBagConstraints spConstraint = new GridBagConstraints();
		spConstraint.gridx = 0;
		spConstraint.gridy = 1;
		spConstraint.fill = GridBagConstraints.HORIZONTAL;
		spConstraint.weighty = 30;
		southPanelWithButtons.add(southPanel, spConstraint);
		wizardDialog.getContentPane().add(southPanelWithButtons, java.awt.BorderLayout.SOUTH);
		wizardDialog.getContentPane().add(cardPanel, java.awt.BorderLayout.CENTER);
		wizardDialog.getContentPane().setBackground(theme.getVioletpastel());
