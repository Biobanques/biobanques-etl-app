...
public class WizardPanelDescriptor {
	...
	/**
	 * Identifier returned by getNextPanelDescriptor() to indicate that this is the last panel and the text of the
	...
	/**
	 * Constructor which accepts both the Object-based identifier and a reference to the Component class which makes up
	 * the panel.
	 * 
	 * @param id
	 *            Object-based identifier
	 * @param panel
	 *            A class which extends java.awt.Component that will be inserted as a panel into the wizard dialog.
	 */
	...
	/**
	 * Sets the Object-based identifier for this panel. The identifier must be unique from all the other identifiers in
	 * the panel.
	 * 
	 * @param id
